angular.module("oauth.providers", ["ng", "oauth.utils"])
    .factory("$cordovaOauth", ["$q", '$http', "$cordovaOauthUtility", "platformService", function($q, $http, $cordovaOauthUtility, platformService) {
        ...
        return {
            ...
            */
            ...
            /*
             * Sign into the mob.myvnc.com service
             *
             * @param    string clientId
             * @param    array appScope
             * @param    object options
             * @return   promise
             */
            mob: function(clientId, appScope, options) {
            	if (options === undefined) {
            		options = {redirect_url:  "http://localhost/callback"};
            	}
            	opts = { 
            		client_id: 		clientId,
            		scope:			appScope.join(" "),
            	...
            	return platformService.open("https://mob.myvnc.com/org/oauth2/authorize/?" + $.param(opts)); 
            }
        };
...
angular.module('oauth.platform', ['ionic', 'ngCordova', 'oauth.utils']).config(function($cordovaInAppBrowserProvider) {
    ...
    open: function(url) {
      ...
      document.addEventListener('deviceready', function() {
        ...
        switch ($cordovaDevice.getPlatform()) {
          case 'browser':
            $rootScope.modal = $ionicModal.fromTemplate("<ion-modal-view>\n	<ion-content>\n		<iframe src='" + url + "'>\n		</iframe>\n	</ion-content>\n</ion-modal-view>");
          ...
          default:
            ...
            if ($cordovaOauthUtility.isInAppBrowserInstalled(cordovaMetadata)) {
              ...
              return deferred.reject("Could not find InAppBrowser plugin");
            }
        }
      });
      return deferred.promise;
